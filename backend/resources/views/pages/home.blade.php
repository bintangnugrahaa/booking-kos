                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/location.svg" class="w-5 h-5 flex shrink-0"
                                            alt="icon">
                                        <p class="text-sm text-ngekos-grey">{{ $boardingHouse->city->name }} City
                                        </p>
                                    </div>
                                    <div class="flex items-center gap-[6px]">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        ...
                                        <p class="text-sm text-ngekos-grey">
                                            {{ $boardingHouse->rooms->count() }} Rooms
                                        <p>
                                    </div>
                                    <hr class="border-[#F1F2F6]">
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-3 w-full">
                            ...
                            <div class="flex items-center gap-[6px]">
                                <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0"
                                    alt="icon">
                                <p class="text-sm text-ngekos-grey">{{ $boardingHouse->rooms->count() }} Rooms
                                </p>
                            </div>
                            <hr class="border-[#F1F2F6]">
                            <p class="font-semibold text-lg text-ngekos-orange">Rp
